...
mechacar_mpg_df <- read.csv(file="/Users/crkaide/OneDrive - IL State University/Vanderbilt/Vanderbilt/Assignments/15_Statistics_and_R/MechaCar_Statistical_Analysis/MechaCar_mpg.csv",check.names=F,stringsAsFactors=F)
